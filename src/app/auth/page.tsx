...
export default function AuthPage() {
    ...
    const features = [
      ...
      },
      {
        icon: Shield,
        title: "Privacy First",
        description: "Your conversations are encrypted and secure with enterprise-grade protection"
      },
      {
        icon: Users,
        title: "Team Collaboration",
        description: "Share conversations and collaborate with your team members seamlessly"
      },
      {
        icon: MessageSquare,
        ...
        <header className="border-b border-border">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-medium">ChatAI</h1>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Experience next-generation AI chat that understands context, learns from your preferences, 
              and delivers intelligent responses that feel truly human.
            </p>
        ...
        <section className="py-20 px-4 bg-muted/50">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl mb-4">Why Choose ChatAI?</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Discover the powerful features that make our AI chat platform the preferred choice 
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join over 10,000+ users who are already experiencing the future of AI communication.
            </p>
            <SignUpButton mode="modal">
              <Button 
                size="lg" 
        ...
        <footer className="border-t border-border py-12 px-4">
          <div className="container mx-auto">
            ...
            <div className="mt-8 pt-8 border-t border-border text-center text-muted-foreground">
              <p>&copy; 2025 ChatAI. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
